...
//var newfilename =title+ timeString;
    ...
    $.ajax({
        //url: "http://driverbest.net/file/checkuploadvideo", //데이터 보낼  url 입력
        url: "https://kyscodeman.pythonanywhere.com/fileUpload_theaf", //데이터 보낼  url 입력
        type: "POST",
...
function gomp3page(){
    	...
    	mp3state = "";
    	window.location.replace("http://driverbest.net/resources/html/alarm_play_theaf.html");
...
function gpsloc() {
    ...
    if (navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(function (pos) {
            ...
            $.ajax({
                url: "http://driverbest.net/gps/insert", //데이터 보낼  url 입력
                type: "POST",
                traditional : true,
...
function wanttheaf(){
$.ajax({
    url: "http://driverbest.net/file/wanttheaf?memno="+meberno,
