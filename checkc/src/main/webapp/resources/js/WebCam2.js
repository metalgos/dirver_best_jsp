...
let jsp_dir = 'http://112.164.139.187:8085/controller/'
let flask_dir = 'http://112.164.139.187:5000/'
...
//var newfilename =title+ timeString;
    ...
    $.ajax({
        ...
        url: flask_dir+"/fileUpload", //데이터 보낼  url 입력
        type: "POST",
...
function gomp3page(){
    	...
    	mp3state = "";
    	window.location.replace(jsp_dir+"resources/html/alarm_play.html");
...
function gpsloc() {
    ...
    if (navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(function (pos) {
            ...
            $.ajax({
                url: jsp_dir+"gps/insert", //데이터 보낼  url 입력
                type: "POST",
                traditional : true,
...
function wantsleepy(){
$.ajax({
    url: jsp_dir+"file/wantsleepy?memno="+meberno,
