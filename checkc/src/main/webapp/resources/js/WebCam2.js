...
//var newfilename =title+ timeString;
    ...
    $.ajax({
        ...
        url: "kyscodeman.pythonanywhere.com/fileUpload", //데이터 보낼  url 입력
        type: "POST",
...
function gomp3page(){
    	...
    	mp3state = "";
    	window.location.replace("http://driverbest.net/resources/html/alarm_play.html");
...
function wantsleepy(){
$.ajax({
    url: "http://driverbest.net/file/wantsleepy?memno="+meberno,
